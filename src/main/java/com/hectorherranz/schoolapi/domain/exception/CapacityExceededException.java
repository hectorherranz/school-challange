...
/**
 * Thrown when an attempt is made to enrol a student in a school that has already reached its
 * maximum capacity.
 *
 * <p>Lives in the <strong>domain</strong> layer so the aggregate can raise it without depending on
