...
class StudentTest {
    ...
    void shouldHandleNullSchoolId() {
        ...
        // When & Then
        assertThrows(NullPointerException.class, () -> new Student(studentId, studentName, nullSchoolId));
    }
    ...
    void shouldHandleNullStudentId() {
        ...
        // When & Then
        assertThrows(NullPointerException.class, () -> new Student(nullStudentId, studentName, schoolId));
    }
}
