...
class UpdateSchoolHandlerTest {
    ...
    void handle_UpdateNameOnly_UpdatesSchoolName() {
        ...
        UpdateSchoolCommand command = new UpdateSchoolCommand(schoolId, Optional.of(newName), Optional.empty());
    ...
    void handle_UpdateCapacityOnly_UpdatesSchoolCapacity() {
        ...
        UpdateSchoolCommand command = new UpdateSchoolCommand(schoolId, Optional.empty(), Optional.of(newCapacity));
    ...
    void handle_UpdateBothNameAndCapacity_UpdatesBoth() {
        ...
        UpdateSchoolCommand command = new UpdateSchoolCommand(schoolId, Optional.of(newName), Optional.of(newCapacity));
    ...
    void handle_SchoolNotFound_ThrowsNotFoundException() {
        // Arrange
        UUID schoolId = UUID.randomUUID();
        UpdateSchoolCommand command = new UpdateSchoolCommand(schoolId, Optional.of("New Name"), Optional.empty());
    ...
    void handle_SameName_DoesNotCheckForDuplicate() {
        ...
        UpdateSchoolCommand command = new UpdateSchoolCommand(schoolId, Optional.of(name), Optional.empty());
    ...
    void handle_NoUpdates_DoesNotModifySchool() {
        ...
        School existingSchool = new School(schoolId, name, new Capacity(capacity));
        UpdateSchoolCommand command = new UpdateSchoolCommand(schoolId, Optional.empty(), Optional.empty());
